...
namespace bharathome_api.Migrations
{
    ...
    [Migration("20260512222742_AddListingIntentToProperty")]
    partial class AddListingIntentToProperty
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Property", b =>
                {
                    ...
                    b.Property<string>("ListingIntent")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("listing_intent");
                    ...
                    b.Property<string>("ReraDocumentUrl")
                        .HasColumnType("text")
                        .HasColumnName("rera_document_url");
            ...
            modelBuilder.Entity("UserProfile", b =>
                {
                    ...
                    b.Property<string>("CurrentPlanTier")
                        .HasColumnType("text")
                        .HasColumnName("current_plan_tier");
            ...
            modelBuilder.Entity("bharathome_api.Model.PaymentRequest", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");

                    b.Property<int>("AmountInr")
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("PlanCycle")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("plan_cycle");
            ...
            modelBuilder.Entity("bharathome_api.Model.PaymentRequest", b =>
                {
                    b.HasOne("UserProfile", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_payment_requests_user_profiles_user_id");
