...
INSERT INTO UserProfiles (Id, Name, Email, Phone, PasswordHash,Image, Provider, AccountStatus, UserType)
VALUES 
('a1', 'Sunny Paul', '', '975-959-8991', NULL, 'sunny_paul.jpg', 'local', 1, 'agent'),
('a2', 'Priya Verma', '', '', NULL, 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=400&q=80', 'local', 1, 'agent');
